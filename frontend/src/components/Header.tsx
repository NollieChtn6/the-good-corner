...
function Header() {
  ...
  if (loading) {
    return <p>Chargement des catégories en cours...</p>;
  }
  if (error) {
    return <p>Une erreur est survenue lors du chargement des catégories.</p>;
  }
  ...
  return (
    <header className="header">
      <div className="header-content">
        ...
        <NavLink to="/annonces/nouvelle-annonce" className="button link-button">
